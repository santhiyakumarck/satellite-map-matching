...
def main():
    ...
    frame_timestamp_ns = get_frame_timestamp()
    ...
    timings["superpoint_superglue"] = matching_time
    ...
    print(
       f"Timestamp -> GPS       : "
       f"{timings.get('timestamp_gps', 0):.4f} s"
    )

    print(
       f"SuperPoint + SuperGlue : "
       f"{timings.get('superpoint_superglue', 0):.4f} s"
    )

    print(
       f"RANSAC                 : "
       f"{timings.get('ransac', 0):.4f} s"
    )

    print(
       f"Position estimation    : "
       f"{timings.get('position_estimation', 0):.4f} s"
    )
